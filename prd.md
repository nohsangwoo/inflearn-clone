(Next.js + TypeScript + S3/CloudFront + ffmpeg + hls.js 전제)
...
_(For brevity, you can directly shell out to the `scripts/add-audio.ts` from the API route using a worker/queue in your environment.)_
