...
const fontStack = "Inter, Arial, 'Apple SD Gothic Neo', 'Noto Sans KR', sans-serif";
...
<svg width="960" height="240" viewBox="0 0 960 240" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="232" y="113" fill="${colors.ink}" font-family="${fontStack}" font-size="62" font-weight="800" letter-spacing="0">Lingoost</text>
  <text x="235" y="158" fill="${colors.body}" font-family="${fontStack}" font-size="28" font-weight="600" letter-spacing="0">Course marketplace by Ludgi Inc.</text>
  <text x="235" y="195" fill="${colors.muted}" font-family="${fontStack}" font-size="23" font-weight="500" letter-spacing="0">강의를 만들고, 판매하고, 수강하는 링구스트</text>
</svg>`;
}
...
<svg width="1200" height="630" viewBox="0 0 1200 630" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="208" y="150" fill="${colors.primary}" font-family="${fontStack}" font-size="42" font-weight="800" letter-spacing="0">Lingoost</text>
  <text x="104" y="260" fill="${colors.ink}" font-family="${fontStack}" font-size="60" font-weight="800" letter-spacing="0">Build, sell, and learn</text>
  <text x="104" y="332" fill="${colors.ink}" font-family="${fontStack}" font-size="60" font-weight="800" letter-spacing="0">with Lingoost</text>
