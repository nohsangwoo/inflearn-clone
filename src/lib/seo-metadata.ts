...
export const siteConfig = {
  ...
  descriptionEn: 'Lingoost is a web-first online course marketplace and LMS reference build by LUDGI Inc. for seasonal course launches, HLS learning, seller dashboards, SEO, and manual payouts.',
  keywords: [
    '링구스트',
    'Lingoost',
    '럿지',
  ...
  keywordsEn: 'Lingoost, LUDGI Inc., Ludgi Inc., LMS development, online course platform development, course marketplace, sell online courses, course creator marketplace, HLS learning, VOD platform, creator education, cohort courses, edtech development',
  url: brand.url,
  ...
  creatorEn: brand.creatorEn,
  email: brand.supportEmail,
  phone: brand.phoneInternational,
  address: {
    street: brand.address,
    city: '인천',
    region: '인천광역시',
    postalCode: '22606',
    country: 'KR'
  ...
  return {
    ...
    '@graph': [
      ...
      },
      {
        ...
        taxID: brand.businessRegistrationNumber,
        duns: brand.dunsNumber,
        address: {
          '@type': 'PostalAddress',
