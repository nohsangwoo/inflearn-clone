...
function PaginationPrevious({ className, ...props }: React.ComponentProps<typeof PaginationLink>) {
  return (
    <PaginationLink aria-label="이전 페이지" className={cn("gap-1 px-2.5 sm:pl-2.5", className)} {...props}>
...
function PaginationNext({ className, ...props }: React.ComponentProps<typeof PaginationLink>) {
  return (
    <PaginationLink aria-label="다음 페이지" className={cn("gap-1 px-2.5 sm:pr-2.5", className)} {...props}>
