    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <h1 className="text-3xl font-black">강의 관리</h1>
                ...
                return (
                  <div key={lecture.id} className="grid gap-4 p-4 md:grid-cols-[72px_1fr_180px_110px] md:items-center">
                    <button
                      ...
                      className="aspect-video w-full overflow-hidden rounded-md border bg-muted md:size-[72px]"
                    >
                      {image ? (
                    ...
                    <div className="min-w-0 space-y-2">
                      ...
                      <button
                        onClick={() => router.push(withLocalePath(pathname, `/admin/courses/${lecture.id}`))}
                        className="block truncate text-left text-lg font-black hover:text-primary"
                      >
                        {lecture.title}
                      </button>
